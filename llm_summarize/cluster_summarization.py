        ...
        try:
            with get_openai_callback() as openai_cb:
                ...
                vectors = self.embeddings.embed_documents(
                    texts=[x.page_content for x in document_splits],
                ...
                sorted_documents = [
                    document_splits[idx].page_content for idx in selected_indices
                ]
