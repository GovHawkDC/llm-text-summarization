...
class SentencizerSplitter:
    def __init__(self, config_dict):
        ...
        self.approx_total_doc_tokens = config_dict["sentence_splitter"][
            "approx_total_doc_tokens"
        ]
        self.tolerance_limit_tokens = config_dict["sentence_splitter"][
            "tolerance_limit_tokens"
        ]
        self.nlp = English()
    ...
    def create_documents(self, content):
        ...
        for sent in nlp_docs.sents:
            ...
            if (
                sent_total_tokens + token_sum
                >= self.approx_total_doc_tokens + self.tolerance_limit_tokens
            ):
